...
/**
 * The class GUI is one of the only two graphic user interface classes in the game
 * The functionality of this class is having two timers that ensures the game
 * keep on going and the world and the player get repainted when any action event
 * happens.
...
public class GUI extends JFrame {
	...
	/**
	 * Preforms this finction when the space bar is clicked
	 * Before the acton is preformed it checks to see if the player is on the ground or not this ensures
	 * That no double jump will be preformed as well as ensures the player does not go off the map
	 ...
	 * The other checks to see if the hitdetection retrns true and if it does it will reset the playerY
	 * Otherwie the player will continue going straight
	 */
  ...
  /**
	 * initialize the timer and the map
	 */
	public void move() {
		initialize();
