...
/**
 * The class Spike is the class that generates the five obstacles in each level of the game.
 * It generates the location of the obstacles randomly but also makes sure
 * they are seprated from each other at a certain distance.
 * To use this class, we make a call in Main class, it works togethr with GUI class
 * to make sure the game has fully functionalities, has both the correct location when
 * playing and being displayed properly.
...
public class Spike{
  ...
  public void drawspike(){
    ...
    tri5 = drawspike.nextInt(200)+1275;
